...
package ir.androidcoder.bazaarpayment.payment.util;
...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
      ...
      //  Intent serviceIntent = new Intent("net.jhoobin.jhub.InAppBillingService.BIND");
      //  serviceIntent.setPackage("net.jhoobin.jhub");
